...
<div class="school-print">
    ...
    <div class="no-print d-flex justify-content-between w-100">
        <span><?= Html::a('<span class="fa fa-backward"></span> Back', ['student-adm-particular/index', 'id' => $model->id], ['class' => ' btn btn-danger btn-xs',]) ?></span>
    ...
    <div id="report">
        ...
        <table class="w-100 font-weight-bold">
            <tr>
                <td>Name: <?= $model->stud_name ?></td>
                <td>Class: <?= $class[$model->course_id] ?></td>
                <td>Gender: <?= $model->gender ?></td>
            </tr>
            <tr>
                <td style="padding-top: 30px">Address: <?= $model->permanent_address ?></td>
            </tr>
        </table>
        ...
        <div class="table-responsive">
            <h5>Student Admission-Fee Payment Details:</h5>
            <table class="table table-bordered">
                ...
                <tr>
                    <td><?= "1" ?></td>
                    <td><?= 'Admission Fee' ?></td>
                    <td><?= "Rs ".$admfee->total_fee ?></td>
                    <td><?= "Rs ".$admfee->discount ?></td>
                    <td><?= "Rs ".$admfee->fine ?></td>
                    <td><?= "Rs ".$admfee->payable_amount ?></td>
                  
                </tr>

                <tr  class= 'non' style="border: none">
                    <th style="border: none"colspan="5" class="text-right non">Amount Received : </th>
                    <td class= 'non' style="border: none"><?= "Rs ".$admfee->amount_received ?></td>
                </tr>
                <tr  class= 'non' style="border: none">
                    <th style="border: none" colspan="5" class="text-right non">Due Amount (if any) : </th>
                    <td class= 'non' style="border: none"><?= "Rs ".$admfee->due_amount ?></td>
                </tr>
                <tr  class= 'non' style="border: none">
                    <th style="border: none" colspan="5" class="text-right non">Payment Type : </th>
                    <td class= 'non' style="border: none"><?= $admfee->payment_type ?></td>
                </tr>
